...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "manage_dict-data": () => import("@/views/manage/dict-data/[id].vue"),
  ...
  monitor_log_login: () => import("@/views/monitor/log/login/index.vue"),
  monitor_log_operate: () => import("@/views/monitor/log/operate/index.vue"),
