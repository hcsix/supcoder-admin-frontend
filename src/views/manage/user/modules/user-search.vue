...
const model = defineModel<SystemUserApi.UserSearchParams>('model', { required: true });

type RuleKey = Extract<keyof SystemUserApi.UserSearchParams, 'userEmail' | 'userPhone'>;
